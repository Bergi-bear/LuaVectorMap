...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("hpea"), 2195.7, -515.8, 356.660, FourCC("hpea"))
end
...
WM("wGeometry", function(import, export, exportDefault)
	...
	Matrix3 = {
		...
		-- @param a number
		-- @return Matrix3
		-- @see https://en.wikipedia.org/wiki/Axis4.940656E-3232%93angle_representation
...
function config()
    ...
    DefineStartLocation(0, 2624.0, -512.0)
